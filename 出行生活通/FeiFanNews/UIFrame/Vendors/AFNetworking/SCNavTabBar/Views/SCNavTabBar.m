...
- (void)viewConfig
{
    ...
    if (_showArrowButton)
    {
        ...
        [self viewShowShadow:_arrowButton shadowRadius:15.0f shadowOpacity:15.0f];
...
{
    _line = [[UIView alloc] initWithFrame:CGRectMake(2.0f, NAV_TAB_BAR_HEIGHT - 28.0f, width - 4.0f, 25.0f)];
    _line.layer.cornerRadius = 7;
    _line.backgroundColor = UIColorWithRGBA(248.0f, 198.0f, 155.0f, 0.5f);
